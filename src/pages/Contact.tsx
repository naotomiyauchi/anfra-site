...
const Contact: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
      <>
        <Helmet>
          <title>お問い合わせ | 合同会社Anfra</title>
          <meta name="description" content="合同会社Anfraへのお問い合わせはこちらから。Web制作・システム開発のご相談をお待ちしています。" />
          <meta property="og:title" content="お問い合わせ | 合同会社Anfra" />
          <meta property="og:description" content="合同会社Anfraへのお問い合わせはこちらから。Web制作・システム開発のご相談をお待ちしています。" />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://あなたのドメイン/contact" />
